        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100">
            <div className="relative h-64 sm:h-80 md:h-[400px]">
               <img src={getImageUrl(car.image_url)} alt={car.name} onError={(e) => { e.currentTarget.src = "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=600&auto=format&fit=crop"; }} className="w-full h-full object-cover" />
